...
public class AirportRepositorySpringJdbc implements AirportRepository{
    ...
    public List<Airport> findAll(){
        return this.jdbcTemplate.query(
                "select airport.name as name, airport.code as code, city.id as city_id, city.name as city from airport inner join city where airport.city = city.id order by name", 
    ...
    public Airport findByCode(final String code){
        return this.jdbcTemplate.queryForObject(
                "select airport.name as name, airport.code as code, city.id as city_id, city.name as city from airport inner join city where airport.city = city.id and code = ?",
